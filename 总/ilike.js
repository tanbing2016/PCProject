...
var iLike = (function ($){
	...
	.NIE-ilike-style1{height:20px;line-height:20px;padding:0 5px 0 25px;border:1px solid #ff6666;border-radius:2px;background:#fff url(http://res.nie.netease.com/comm/js/ilike/1.png) 5px -1px no-repeat;}\
	...
	.NIE-ilike-style2{height:30px;line-height:30px;padding-left:35px;background:url(http://res.nie.netease.com/comm/js/ilike/2.png) 0 0 no-repeat;}\
	.NIE-ilike-style2:hover{background-position:0 -30px;}\
	.NIE-ilike-style3{min-width:82px;_width:82px;height:30px;line-height:30px;padding-top:82px;background:url(http://res.nie.netease.com/comm/js/ilike/3.png) 50% 0 no-repeat;text-align:center;background-image:url(http://res.nie.netease.com/comm/js/ilike/3.ie6.png);}.NIE-ilike-style3:hover{background-position:50% -112px;}\
    ...
    var iLike = function (options) {
        this.options = $.extend({
			parent:'body',
			style:1,
			countUrl:'http://nie-like.webapp.163.com/count/',
			likeUrl:'http://nie-like.webapp.163.com/like/'
		},options);
		this.init();
    }
