    ...
    function str(t, e) {
        ...
        switch (f && "object" == typeof f && "function" == typeof f.toJSON && (f = f.toJSON(t)), "function" == typeof rep && (f = rep.call(e, t, f)), typeof f) {
            ...
            case"object":
                ...
                if (rep && "object" == typeof rep)for (u = rep.length, n = 0; u > n; n += 1)"string" == typeof rep[n] && (r = rep[n], o = str(r, f), o && i.push(quote(r) + (gap ? ": " : ":") + o)); else for (r in f)Object.prototype.hasOwnProperty.call(f, r) && (o = str(r, f), o && i.push(quote(r) + (gap ? ": " : ":") + o));
                return o = 0 === i.length ? "{}" : gap ? "{\n" + gap + i.join(",\n" + gap) + "\n" + a + "}" : "{" + i.join(",") + "}", gap = a, o
        }
    }
...
var BJ_REPORT = function (t) {
    ...
    var e = [], n = {
        ...
        var e = t.stack.replace(/\n/gi, "").split(/\bat\b/).slice(0, 5).join("@").replace(/\?[^:]+/gi, ""), n = t.toString();
        ...
        if (n.report) {
            for (; e.length;) {
                var o = !1, u = e.shift(), i = f(u, p.length);
                if (r(n.ignore, "Array"))for (var a = 0, s = n.ignore.length; s > a; a++) {
                    var g = n.ignore[a];
        ...
        push: function (t) {
            ...
            return r && (/qq\.com$/gi.test(window.location.hostname) && (n.url || (n.url = "//badjs2.qq.com/badjs"), n.uin || (n.uin = parseInt((document.cookie.match(/\buin=\D+(\d+)/) || [])[1], 10))), n.report = n.url + "?id=" + r + "&uin=" + n.uin + "&from=" + encodeURIComponent(location.href) + "&ext=" + JSON.stringify(n.ext) + "&"), y
...
"undefined" != typeof exports && ("undefined" != typeof module && module.exports && (exports = module.exports = BJ_REPORT), exports.BJ_REPORT = BJ_REPORT), function (t) {
    if (t.BJ_REPORT) {
        var e, n = function (e) {
        ...
        r.spyJquery = function () {
            ...
            var e = t.require, n = t.define;
            return n && n.amd && e && (t.require = a(e), o(t.require, e), t.define = a(n), o(t.define, n)), t.seajs && n && (t.define = function () {
                for (var t, e = [], r = 0, o = arguments.length; o > r; r++)t = arguments[r], u(t) && (t = i(t), t.toString = function (t) {
                    return function () {
                        return t.toString()
                    }
                }(arguments[r])), e.push(t);
                return n.apply(this, e)
            }, t.seajs.use = a(t.seajs.use), o(t.define, n)), r
...
;!function (e, t) {
    ...
    function f(e, t, n, r) {
        ...
        }); else if (n || null == t || "object" != typeof t)r(e, t); else for (var i in t)f(e + "[" + i + "]", t[i], n, r)
    }
    ...
    function p(e, n, r, i, o, a) {
        ...
        for (var s, l = e[o], u = 0, c = l ? l.length : 0, f = e === nn; c > u && (f || !s); u++)s = l[u](n, r, i), "string" == typeof s && (!f || a[s] ? s = t : (n.dataTypes.unshift(s), s = p(e, n, r, i, s, a)));
        return (f || !s) && !a["*"] && (s = p(e, n, r, i, "*", a)), s
    }

    function h(e) {
        return function (t, n) {
            if ("string" != typeof t && (n = t, t = "*"), B.isFunction(n))for (var r, i, o, a = t.toLowerCase().split(Qt), s = 0, l = a.length; l > s; s++)r = a[s], o = /^\+/.test(r), o && (r = r.substr(1) || "*"), i = e[r] = e[r] || [], i[o ? "unshift" : "push"](n)
        }
    }

    function m(e, t, n) {
        var r = "width" === t ? e.offsetWidth : e.offsetHeight, i = "width" === t ? Bt : Pt;
        return r > 0 ? ("border" !== n && B.each(i, function () {
            ...
            r += parseFloat(B.css(e, "padding" + this)) || 0, "padding" !== n && (r += parseFloat(B.css(e, "border" + this + "Width")) || 0), "margin" === n && (r += parseFloat(B.css(e, n + this)) || 0)
        }), r + "px")
    }
    ...
    function g(e, t) {
        t.src ? B.ajax({
            ...
            async: !1,
            dataType: "script"
        }) : B.globalEval((t.text || t.textContent || t.innerHTML || "").replace(Ct, "/*$0*/")), t.parentNode && t.parentNode.removeChild(t)
    }
    ...
    function T(e, t) {
        if (1 === t.nodeType && B.hasData(e)) {
            var n = B.expando, r = B.data(e), i = B.data(t, r);
            if (r = r[n]) {
                var o = r.events;
    ...
    function S(e) {
        var t, n, r, i, o, a, s, l, u, c, f, d, p = [], h = [], m = B._data(this, "events");
        if (e.liveFired !== this && m && m.live && !e.target.disabled && (!e.button || "click" !== e.type)) {
            ...
            for (i = B(e.target).closest(h, e.currentTarget), l = 0, u = i.length; u > l; l++)for (c = i[l], s = 0; s < g.length; s++)o = g[s], c.selector !== o.selector || f && !f.test(o.namespace) || c.elem.disabled || (a = c.elem, r = null, ("mouseenter" === o.preType || "mouseleave" === o.preType) && (e.type = o.preType, r = B(e.relatedTarget).closest(o.selector)[0], r && B.contains(a, r) && (r = a)), (!r || r !== a) && p.push({
                elem: a,
                handleObj: o,
                level: c.level
            }));
    ...
    function F(e, n, r) {
        var i = n + "defer", o = n + "queue", a = n + "mark", s = B.data(e, i, t, !0);
    ...
    var M = e.document, O = e.navigator, H = e.location, B = function () {
        function n() {
            if (!s.isReady) {
                try {
        ...
        }, l = e.jQuery, u = e.$, c = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, f = /\S/, d = /^\s+/, p = /\s+$/, h = /\d/, m = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, g = /^[\],:{}\s]*$/, y = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, v = /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, b = /(?:^|:|,)(?:\s*\[)+/g, x = /(webkit)[ \/]([\w.]+)/, T = /(opera)(?:.*version)?[ \/]([\w.]+)/, w = /(msie) ([\w.]+)/, N = /(mozilla)(?:.*? rv:([\w.]+))?/, C = /-([a-z]|[0-9])/gi, E = /^-ms-/, S = function (e, t) {
            return (t + "").toUpperCase()
        }, A = O.userAgent, k = Object.prototype.toString, D = Object.prototype.hasOwnProperty, F = Array.prototype.push, j = Array.prototype.slice, L = String.prototype.trim, H = Array.prototype.indexOf, B = {};
        return s.fn = s.prototype = {
            constructor: s, init: function (e, n, r) {
                ...
                if ("string" == typeof e) {
                    if (i = "<" !== e.charAt(0) || ">" !== e.charAt(e.length - 1) || e.length < 3 ? c.exec(e) : [null, e, null], i && (i[1] || !n)) {
                        if (i[1])return n = n instanceof s ? n[0] : n, l = n ? n.ownerDocument || n : M, a = m.exec(e), a ? s.isPlainObject(n) ? (e = [M.createElement(a[1])], s.fn.attr.call(e, n, !0)) : e = [l.createElement(a[1])] : (a = s.buildFragment([i[1]], [l]), e = (a.cacheable ? s.clone(a.fragment) : a.fragment).childNodes), s.merge(this, e);
                ...
                return s.isArray(e) ? F.apply(r, e) : s.merge(r, e), r.prevObject = this, r.context = this.context, "find" === t ? r.selector = this.selector + (this.selector ? " " : "") + n : t && (r.selector = this.selector + "." + t + "(" + n + ")"), r
            }, each: function (e, t) {
            ...
            noConflict: function (t) {
                ...
                if (!o) {
                    ...
                    if (M.addEventListener)M.addEventListener("DOMContentLoaded", a, !1), e.addEventListener("load", s.ready, !1); else if (M.attachEvent) {
                ...
                } else for (; a > o && n.apply(e[o++], r) !== !1;); else if (l) {
                ...
                var r = e.length, i = 0;
                if ("number" == typeof n.length)for (var o = n.length; o > i; i++)e[r++] = n[i]; else for (; n[i] !== t;)e[r++] = n[i++];
                return e.length = r, e
            }, grep: function (e, t, n) {
                var r, i = [];
                n = !!n;
                ...
                if (c)for (; u > l; l++)i = n(e[l], l, r), null != i && (a[a.length] = i); else for (o in e)i = n(e[o], o, r), null != i && (a[a.length] = i);
        ...
        }), i = s.uaMatch(A), i.browser && (s.browser[i.browser] = !0, s.browser.version = i.version), s.browser.webkit && (s.browser.safari = !0), f.test(" ") && (d = /^[\s\xA0]+/, p = /[\s\xA0]+$/), r = s(M), M.addEventListener ? a = function () {
    ...
    }(), P = "done fail isResolved isRejected promise then always pipe".split(" "), q = [].slice;
    B.extend({
        _Deferred: function () {
            var e, t, n, r = [], i = {
                done: function () {
            ...
            var t, n = B._Deferred(), r = B._Deferred();
            return B.extend(n, {
                then: function (e, t) {
            ...
            var n = arguments, r = 0, i = n.length, o = i, a = 1 >= i && e && B.isFunction(e.promise) ? e : B.Deferred();
            if (i > 1) {
        ...
        var e, t, n, r, i, o, a, s, l, u, c, f, d, p, h, m, g = M.createElement("div"), y = M.documentElement;
        ...
        n = M.createElement("select"), r = n.appendChild(M.createElement("option")), i = g.getElementsByTagName("input")[0], a = {
        ...
        !g.addEventListener && g.attachEvent && g.fireEvent && (g.attachEvent("onclick", function () {
            a.noCloneEvent = !1
        }), g.cloneNode(!0).fireEvent("onclick")), i = M.createElement("input"), i.value = "t", i.setAttribute("type", "radio"), a.radioValue = "t" === i.value, i.setAttribute("checked", "checked"), g.appendChild(i), s = M.createDocumentFragment(), s.appendChild(g.firstChild), a.checkClone = s.cloneNode(!0).cloneNode(!0).lastChild.checked, g.innerHTML = "", g.style.width = g.style.paddingLeft = "1px", l = M.getElementsByTagName("body")[0], c = M.createElement(l ? "div" : "body"), f = {
            visibility: "hidden",
            width: 0,
            height: 0,
            border: 0,
        ...
        if (c.appendChild(g), u = l || y, u.insertBefore(c, u.firstChild), a.appendChecked = i.checked, a.boxModel = 2 === g.offsetWidth, "zoom" in g.style && (g.style.display = "inline", g.style.zoom = 1, a.inlineBlockNeedsLayout = 2 === g.offsetWidth, g.style.display = "", g.innerHTML = "<div style='width:4px;'></div>", a.shrinkWrapBlocks = 2 !== g.offsetWidth), g.innerHTML = "<table><tr><td style='padding:0;border:0;display:none'></td><td>t</td></tr></table>", d = g.getElementsByTagName("td"), m = 0 === d[0].offsetHeight, d[0].style.display = "", d[1].style.display = "none", a.reliableHiddenOffsets = m && 0 === d[0].offsetHeight, g.innerHTML = "", M.defaultView && M.defaultView.getComputedStyle && (o = M.createElement("div"), o.style.width = "0", o.style.marginRight = "0", g.appendChild(o), a.reliableMarginRight = 0 === (parseInt((M.defaultView.getComputedStyle(o, null) || {marginRight: 0}).marginRight, 10) || 0)), c.innerHTML = "", u.removeChild(c), g.attachEvent)for (h in{
            submit: 1,
            change: 1,
            focusin: 1
    ...
    B.extend({
        ...
        data: function (e, n, r, i) {
            if (B.acceptData(e)) {
                var o, a, s = B.expando, l = "string" == typeof n, u = e.nodeType, c = u ? B.cache : e, f = u ? e[B.expando] : e[B.expando] && B.expando;
                if ((!f || i && f && c[f] && !c[f][s]) && l && r === t)return;
                return f || (u ? e[B.expando] = f = ++B.uuid : f = B.expando), c[f] || (c[f] = {}, u || (c[f].toJSON = B.noop)), ("object" == typeof n || "function" == typeof n) && (i ? c[f][s] = B.extend(c[f][s], n) : c[f] = B.extend(c[f], n)), o = c[f], i && (o[s] || (o[s] = {}), o = o[s]), r !== t && (o[B.camelCase(n)] = r), "events" !== n || o[n] ? (l ? (a = o[n], null == a && (a = o[B.camelCase(n)])) : a = o, a) : o[s] && o[s].events
            }
        },
        removeData: function (e, t, n) {
            if (B.acceptData(e)) {
                var r, i = B.expando, o = e.nodeType, a = o ? B.cache : e, s = o ? e[B.expando] : B.expando;
                if (!a[s])return;
                if (t && (r = n ? a[s][i] : a[s], r && (r[t] || (t = B.camelCase(t)), delete r[t], !j(r))))return;
                if (n && (delete a[s][i], !j(a[s])))return;
                var l = a[s][i];
                B.support.deleteExpando || !a.setInterval ? delete a[s] : a[s] = null, l ? (a[s] = {}, o || (a[s].toJSON = B.noop), a[s][i] = l) : o && (B.support.deleteExpando ? delete e[B.expando] : e.removeAttribute ? e.removeAttribute(B.expando) : e[B.expando] = null)
            }
        },
        ...
        data: function (e, n) {
            ...
            if ("undefined" == typeof e) {
                if (this.length && (r = B.data(this[0]), 1 === this[0].nodeType))for (var i, o = this[0].attributes, a = 0, s = o.length; s > a; a++)i = o[a].name, 0 === i.indexOf("data-") && (i = B.camelCase(i.substring(5)), L(this[0], i, r[i]));
                return r
            }
            ...
            var l = e.split(".");
            return l[1] = l[1] ? "." + l[1] : "", n === t ? (r = this.triggerHandler("getData" + l[1] + "!", [l[0]]), r === t && this.length && (r = B.data(this[0], e), r = L(this[0], e, r)), r === t && l[1] ? this.data(l[0]) : r) : this.each(function () {
                var t = B(this), r = [l[0], n];
        ...
        _mark: function (e, n) {
            ...
            if (e !== !0 && (r = n, n = e, e = !1), n) {
                r = r || "fx";
                var i = r + "mark", o = e ? 0 : (B.data(n, i, t, !0) || 1) - 1;
        ...
        queue: function (e, n) {
            return "string" != typeof e && (n = e, e = "fx"), n === t ? B.queue(this[0], e) : this.each(function () {
    ...
    var W, R, $ = /[\n\t\r]/g, X = /\s+/, z = /\r/g, V = /^(?:button|input)$/i, U = /^(?:button|input|object|select|textarea)$/i, J = /^a(?:rea)?$/i, Y = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i;
    B.fn.extend({
        attr: function (e, t) {
            ...
            return this.each(B.isFunction(e) ? function (n) {
                ...
                if ("string" === n)for (var i, o = 0, a = B(this), s = t, l = e.split(X); i = l[o++];)s = r ? s : !a.hasClass(i), a[s ? "addClass" : "removeClass"](i); else("undefined" === n || "boolean" === n) && (this.className && B._data(this, "__className__", this.className), this.className = this.className || e === !1 ? "" : B._data(this, "__className__") || "")
            })
        }, hasClass: function (e) {
        ...
        valHooks: {
            option: {
                ...
                get: function (e) {
                    var t, n = e.selectedIndex, r = [], i = e.options, o = "select-one" === e.type;
                    if (0 > n)return null;
        ...
        attr: function (e, n, r, i) {
            ...
            return l && (n = B.attrFix[n] || n, s = B.attrHooks[n], s || (Y.test(n) ? s = R : W && (s = W))), r !== t ? null === r ? (B.removeAttr(e, n), t) : s && "set" in s && l && (a = s.set(e, r, n)) !== t ? a : (e.setAttribute(n, "" + r), r) : s && "get" in s && l && null !== (a = s.get(e, n)) ? a : (a = e.getAttribute(n), null === a ? t : a)
        },
        ...
        attrHooks: {
            type: {
                set: function (e, t) {
                    if (V.test(e.nodeName) && e.parentNode)B.error("type property can't be changed"); else if (!B.support.radioValue && "radio" === t && B.nodeName(e, "input")) {
                        var n = e.value;
        ...
        prop: function (e, n, r) {
            ...
            return s && (n = B.propFix[n] || n, a = B.propHooks[n]), r !== t ? a && "set" in a && (o = a.set(e, r, n)) !== t ? o : e[n] = r : a && "get" in a && null !== (o = a.get(e, n)) ? o : e[n]
        },
        propHooks: {
            tabIndex: {
                get: function (e) {
    ...
    }), B.attrHooks.tabIndex = B.propHooks.tabIndex, R = {
        get: function (e, n) {
            var r;
    ...
    var G = /\.(.*)$/, K = /^(?:textarea|input|select)$/i, Q = /\./g, Z = / /g, et = /[^\w\s.|`]/g, tt = function (e) {
        return e.replace(et, "\\$&")
    };
    B.event = {
        add: function (e, n, r, i) {
            if (3 !== e.nodeType && 8 !== e.nodeType) {
                if (r === !1)r = D; else if (!r)return;
                var o, a;
                r.handler && (o = r, r = o.handler), r.guid || (r.guid = B.guid++);
                var s = B._data(e);
                if (!s)return;
                var l = s.events, u = s.handle;
                ...
                for (var c, f, d = 0; c = n[d++];) {
                    a = o ? B.extend({}, o) : {
                        handler: r,
                        data: i
                    }, c.indexOf(".") > -1 ? (f = c.split("."), c = f.shift(), a.namespace = f.slice(0).sort().join(".")) : (f = [], a.namespace = ""), a.type = c, a.guid || (a.guid = r.guid);
                    var p = l[c], h = B.event.special[c] || {};
                    p || (p = l[c] = [], h.setup && h.setup.call(e, i, f, u) !== !1 || (e.addEventListener ? e.addEventListener(c, u, !1) : e.attachEvent && e.attachEvent("on" + c, u))), h.add && (h.add.call(e, a), a.handler.guid || (a.handler.guid = r.guid)), p.push(a), B.event.global[c] = !0
                }
                e = null
            }
        },
        ...
        remove: function (e, n, r, i) {
            if (3 !== e.nodeType && 8 !== e.nodeType) {
                r === !1 && (r = D);
                var o, a, s, l, u, c, f, d, p, h, m = 0, g = B.hasData(e) && B._data(e), y = g && g.events;
                if (!g || !y)return;
        ...
        trigger: function (n, r, i, o) {
            ...
            if (s.indexOf("!") >= 0 && (s = s.slice(0, -1), a = !0), s.indexOf(".") >= 0 && (l = s.split("."), s = l.shift(), l.sort()), i && !B.event.customEvent[s] || B.event.global[s]) {
                if (n = "object" == typeof n ? n[B.expando] ? n : new B.Event(s, n) : new B.Event(s), n.type = s, n.exclusive = a, n.namespace = l.join("."), n.namespace_re = new RegExp("(^|\\.)" + l.join("\\.(?:.*\\.)?") + "(\\.|$)"), (o || !i) && (n.preventDefault(), n.stopPropagation()), !i)return void B.each(B.cache, function () {
        ...
        handle: function (n) {
            ...
            var r = ((B._data(this, "events") || {})[n.type] || []).slice(0), i = !n.exclusive && !n.namespace, o = Array.prototype.slice.call(arguments, 0);
        ...
        fix: function (e) {
            ...
            if (e.target || (e.target = e.srcElement || M), 3 === e.target.nodeType && (e.target = e.target.parentNode), !e.relatedTarget && e.fromElement && (e.relatedTarget = e.fromElement === e.target ? e.toElement : e.fromElement), null == e.pageX && null != e.clientX) {
                var o = e.target.ownerDocument || M, a = o.documentElement, s = o.body;
    ...
    if (B.each({mouseenter: "mouseover", mouseleave: "mouseout"}, function (e, t) {
            ...
            setup: function () {
                return B.nodeName(this, "form") ? !1 : (B.event.add(this, "click.specialSubmit", function (e) {
                    var t = e.target, n = B.nodeName(t, "input") || B.nodeName(t, "button") ? t.type : "";
        ...
        B.event.special.change = {
            filters: {
                focusout: at, beforedeactivate: at, click: function (e) {
                    var t = e.target, n = B.nodeName(t, "input") ? t.type : "";
        ...
        }, it = B.event.special.change.filters, it.focus = it.beforeactivate
    }
    B.support.focusinBubbles || B.each({focus: "focusin", blur: "focusout"}, function (e, t) {
        ...
        B.fn[n] = function (e, r, i) {
            ...
            if ((2 === arguments.length || r === !1) && (i = r, r = t), "one" === n ? (o = function (e) {
                ...
                }, o.guid = i.guid || B.guid++) : o = i, "unload" === e && "one" !== n)this.one(e, r, i); else for (var s = 0, l = this.length; l > s; s++)B.event.add(this[s], e, o, r);
            return this
        }
    }), B.fn.extend({
        unbind: function (e, t) {
            if ("object" != typeof e || e.preventDefault)for (var n = 0, r = this.length; r > n; n++)B.event.remove(this[n], e, t); else for (var i in e)this.unbind(i, e[i]);
            return this
    ...
    B.each(["live", "die"], function (e, n) {
        B.fn[n] = function (e, r, i, o) {
            var a, s, l, u, c = 0, f = o || this.selector, d = o ? this : B(this.context);
            if ("object" == typeof e && !e.preventDefault) {
                for (var p in e)d[n](p, r, e[p], f);
                return this
            }
            if ("die" === n && !e && o && "." === o.charAt(0))return d.unbind(o), this;
            for ((r === !1 || B.isFunction(r)) && (i = r || D, r = t), e = (e || "").split(" "); null != (a = e[c++]);)if (s = G.exec(a), l = "", s && (l = s[0], a = a.replace(G, "")), "hover" !== a)if (u = a, st[a] ? (e.push(st[a] + l), a += l) : a = (st[a] || a) + l, "live" === n)for (var h = 0, m = d.length; m > h; h++)B.event.add(d[h], "live." + E(a, f), {
                data: r,
                selector: f,
                handler: i,
                origType: a,
                origHandler: i,
                preType: u
            }); else d.unbind("live." + E(a, f), i); else e.push("mouseenter" + l, "mouseleave" + l);
            return this
        }
        ...
        var r = /((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g, i = 0, o = Object.prototype.toString, a = !1, s = !0, l = /\\/g, u = /\W/;
        [0, 0].sort(function () {
            return s = !1, 0
        });
        var c = function (e, t, n, i) {
            ...
            var s, l, u, p, h, g, y, v, x = !0, T = c.isXML(t), w = [], N = e;
            do if (r.exec(""), s = r.exec(N), s && (N = s[3], w.push(s[1]), s[2])) {
                p = s[3];
                break
            } while (s);
            if (w.length > 1 && d.exec(e))if (2 === w.length && f.relative[w[0]])l = b(w[0] + w[1], t); else for (l = f.relative[w[0]] ? [t] : c(w.shift(), t); w.length;)e = w.shift(), f.relative[e] && (e += w.shift()), l = b(e, l); else if (!i && w.length > 1 && 9 === t.nodeType && !T && f.match.ID.test(w[0]) && !f.match.ID.test(w[w.length - 1]) && (h = c.find(w.shift(), t, T), t = h.expr ? c.filter(h.expr, h.set)[0] : h.set[0]), t)for (h = i ? {
                expr: w.pop(),
                set: m(i)
            } : c.find(w.pop(), 1 !== w.length || "~" !== w[0] && "+" !== w[0] || !t.parentNode ? t : t.parentNode, T), l = h.expr ? c.filter(h.expr, h.set) : h.set, w.length > 0 ? u = m(l) : x = !1; w.length;)g = w.pop(), y = g, f.relative[g] ? y = w.pop() : g = "", null == y && (y = t), f.relative[g](u, y, T); else u = w = [];
            if (u || (u = l), u || c.error(g || e), "[object Array]" === o.call(u))if (x)if (t && 1 === t.nodeType)for (v = 0; null != u[v]; v++)u[v] && (u[v] === !0 || 1 === u[v].nodeType && c.contains(t, u[v])) && n.push(l[v]); else for (v = 0; null != u[v]; v++)u[v] && 1 === u[v].nodeType && n.push(l[v]); else n.push.apply(n, u); else m(u, n);
        ...
        var f = c.selectors = {
            ...
            relative: {
                "+": function (e, t) {
                    var n = "string" == typeof t, r = n && !u.test(t), i = n && !r;
                    r && (t = t.toLowerCase());
            ...
            filter: {
                PSEUDO: function (e, t, n, r) {
                    ...
                    var n = t[1], r = f.attrHandle[n] ? f.attrHandle[n](e) : null != e[n] ? e[n] : e.getAttribute(n), i = r + "", o = t[2], a = t[4];
        ...
        try {
            ...
            m = function (e, t) {
                var n = 0, r = t || [];
                if ("[object Array]" === o.call(e))Array.prototype.push.apply(r, e); else if ("number" == typeof e.length)for (var i = e.length; i > n; n++)r.push(e[n]); else for (; e[n]; n++)r.push(e[n]);
                return r
            }
        }
        var y, v;
        M.documentElement.compareDocumentPosition ? y = function (e, t) {
            ...
            e.innerHTML = "<a name='" + n + "'/>", r.insertBefore(e, r.firstChild), M.getElementById(n) && (f.find.ID = function (e, n, r) {
            ...
            e.appendChild(M.createComment("")), e.getElementsByTagName("*").length > 0 && (f.find.TAG = function (e, t) {
            ...
            var e = c, t = M.createElement("div"), n = "__sizzle__";
                ...
                c = function (t, r, i, o) {
                    if (r = r || M, !o && !c.isXML(r)) {
                        ...
                        if (9 === r.nodeType) {
                            ...
                            var u = r, d = r.getAttribute("id"), p = d || n, h = r.parentNode, g = /^\s*[+~]/.test(t);
    ...
    var lt = /Until$/, ut = /^(?:parents|prevUntil|prevAll)/, ct = /,/, ft = /^.[^:#\[\.,]*$/, dt = Array.prototype.slice, pt = B.expr.match.POS, ht = {
        children: !0,
        contents: !0,
        next: !0,
        prev: !0
    ...
    B.fn.extend({
            ...
            if (B.isArray(e)) {
                ...
                if (o && e.length) {
                    ...
                    for (; o && o.ownerDocument && o !== t;) {
                        for (s in l)a = l[s], (a.jquery ? a.index(o) > -1 : B(o).is(a)) && i.push({
                            selector: s,
                            elem: o,
                            level: u
                        });
        ...
        B.fn[e] = function (n, r) {
            var i = B.map(this, t, n), o = dt.call(arguments);
            return lt.test(e) || (r = n), r && "string" == typeof r && (i = B.filter(r, i)), i = this.length > 1 && !ht[e] ? B.unique(i) : i, (this.length > 1 || ct.test(r)) && ut.test(e) && (i = i.reverse()), this.pushStack(i, e, o.join(","))
        }
    }), B.extend({
    ...
    var mt = / jQuery\d+="(?:\d+|null)"/g, gt = /^\s+/, yt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, vt = /<([\w:]+)/, bt = /<tbody/i, xt = /<|&#?\w+;/, Tt = /<(?:script|object|embed|option|style)/i, wt = /checked\s*(?:[^=]|=\s*.checked.)/i, Nt = /\/(java|ecma)script/i, Ct = /^\s*<!(?:\[CDATA\[|\-\-)/, Et = {
    ...
    Et.optgroup = Et.option, Et.tbody = Et.tfoot = Et.colgroup = Et.caption = Et.thead, Et.th = Et.td, B.support.htmlSerialize || (Et._default = [1, "div<div>", "</div>"]), B.fn.extend({
        text: function (e) {
            ...
            if (this[0]) {
                if (s = l && l.parentNode, i = B.support.parentNode && s && 11 === s.nodeType && s.childNodes.length === this.length ? {fragment: s} : B.buildFragment(e, this, u), a = i.fragment, o = 1 === a.childNodes.length ? a = a.firstChild : a.firstChild, o) {
                    n = n && B.nodeName(o, "tr");
        ...
        var r, i, o, a;
        return t && t[0] && (a = t[0].ownerDocument || t[0]), a.createDocumentFragment || (a = M), 1 === e.length && "string" == typeof e[0] && e[0].length < 512 && a === M && "<" === e[0].charAt(0) && !Tt.test(e[0]) && (B.support.checkClone || !wt.test(e[0])) && (i = !0, o = B.fragments[e[0]], o && 1 !== o && (r = o)), r || (r = a.createDocumentFragment(), B.clean(e, a, r, n)), i && (B.fragments[e[0]] = o ? r : 1), {
            fragment: r,
            cacheable: i
        }
    }, B.fragments = {}, B.each({
        ...
        B.fn[e] = function (n) {
            var r = [], i = B(n), o = 1 === this.length && this[0].parentNode;
        ...
        clone: function (e, t, n) {
            ...
            for (var o, a, s = [], l = 0; null != (a = e[l]); l++)if ("number" == typeof a && (a += ""), a) {
                if ("string" == typeof a)if (xt.test(a)) {
                    a = a.replace(yt, "<$1></$2>");
                    var u = (vt.exec(a) || ["", ""])[1].toLowerCase(), c = Et[u] || Et._default, f = c[0], d = t.createElement("div");
                    for (d.innerHTML = c[1] + a + c[2]; f--;)d = d.lastChild;
                    if (!B.support.tbody) {
                        var p = bt.test(a), h = "table" !== u || p ? "<table>" !== c[1] || p ? [] : d.childNodes : d.firstChild && d.firstChild.childNodes;
                ...
                var m;
                if (!B.support.appendChecked)if (a[0] && "number" == typeof(m = a.length))for (o = 0; m > o; o++)y(a[o]); else y(a);
            ...
            for (var t, n, r, i = B.cache, o = B.expando, a = B.event.special, s = B.support.deleteExpando, l = 0; null != (r = e[l]); l++)if ((!r.nodeName || !B.noData[r.nodeName.toLowerCase()]) && (n = r[B.expando])) {
    ...
    var St, At, kt, Dt = /alpha\([^)]*\)/i, Ft = /opacity=([^)]*)/, jt = /([A-Z]|^ms)/g, Lt = /^-?\d+(?:px)?$/i, Mt = /^-?\d/, Ot = /^([\-+])=([\-+.\de]+)/, Ht = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, Bt = ["Left", "Right"], Pt = ["Top", "Bottom"];
    B.fn.css = function (e, n) {
        ...
        style: function (e, n, r, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, a, s = B.camelCase(n), l = e.style, u = B.cssHooks[s];
        ...
        get: function (e, t) {
            ...
            var n = e.style, r = e.currentStyle, i = B.isNaN(t) ? "" : "alpha(opacity=" + 100 * t + ")", o = r && r.filter || n.filter || "";
        ...
        var r, i, o;
        return n = n.replace(jt, "-$1").toLowerCase(), (i = e.ownerDocument.defaultView) ? ((o = i.getComputedStyle(e, null)) && (r = o.getPropertyValue(n), "" === r && !B.contains(e.ownerDocument.documentElement, e) && (r = B.style(e, n))), r) : t
    }), M.documentElement.currentStyle && (kt = function (e, t) {
        var n, r = e.currentStyle && e.currentStyle[t], i = e.runtimeStyle && e.runtimeStyle[t], o = e.style;
        return !Lt.test(r) && Mt.test(r) && (n = o.left, i && (e.runtimeStyle.left = e.currentStyle.left), o.left = "fontSize" === t ? "1em" : r || 0, r = o.pixelLeft + "px", o.left = n, i && (e.runtimeStyle.left = i)), "" === r ? "auto" : r
    }), St = At || kt, B.expr && B.expr.filters && (B.expr.filters.hidden = function (e) {
        var t = e.offsetWidth, n = e.offsetHeight;
        return 0 === t && 0 === n || !B.support.reliableHiddenOffsets && "none" === (e.style.display || B.css(e, "display"))
    }, B.expr.filters.visible = function (e) {
        return !B.expr.filters.hidden(e)
    });
    var qt, It, _t = /%20/g, Wt = /\[\]$/, Rt = /\r?\n/g, $t = /#.*$/, Xt = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, zt = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i, Vt = /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/, Ut = /^(?:GET|HEAD)$/, Jt = /^\/\//, Yt = /\?/, Gt = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, Kt = /^(?:select|textarea)/i, Qt = /\s+/, Zt = /([?&])_=[^&]*/, en = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, tn = B.fn.load, nn = {}, rn = {}, on = ["*/"] + ["*"];
    try {
        qt = H.href
    } catch (an) {
        qt = M.createElement("a"), qt.href = "", qt = qt.href
    }
    It = en.exec(qt.toLowerCase()) || [], B.fn.extend({
        load: function (e, n, r) {
            ...
            return B.ajax({
                url: e, type: a, dataType: "html", data: n, complete: function (e, t, n) {
                    n = e.responseText, e.isResolved() && (e.done(function (e) {
                        n = e
                    }), s.html(o ? B("<div>").append(n.replace(Gt, "")).find(o) : n)), r && s.each(r, [n, t, e])
                }
            }), this
        }, serialize: function () {
        ...
        ajax: function (e, n) {
            function r(e, n, r, a) {
                if (2 !== N) {
                    ...
                    var f, p, h, T, w, E = n, S = r ? c(m, C, r) : t;
                    if (e >= 200 && 300 > e || 304 === e)if (m.ifModified && ((T = C.getResponseHeader("Last-Modified")) && (B.lastModified[i] = T), (w = C.getResponseHeader("Etag")) && (B.etag[i] = w)), 304 === e)E = "notmodified", f = !0; else try {
                        p = u(m, S), E = "success", f = !0
                    } catch (A) {
                        E = "parsererror", h = A
                    } else h = E, (!E || e) && (E = "error", 0 > e && (e = 0));
                    C.status = e, C.statusText = "" + (n || E), f ? v.resolveWith(g, [p, E, C]) : v.rejectWith(g, [C, E, h]), C.statusCode(x), x = t, d && y.trigger("ajax" + (f ? "Success" : "Error"), [C, m, f ? p : h]), b.resolveWith(g, [C, E]), d && (y.trigger("ajaxComplete", [C, m]), --B.active || B.event.trigger("ajaxStop"))
                }
            }

            "object" == typeof e && (n = e, e = t), n = n || {};
            var i, o, a, s, l, f, d, h, m = B.ajaxSetup({}, n), g = m.context || m, y = g !== m && (g.nodeType || g instanceof B) ? B(g) : B.event, v = B.Deferred(), b = B._Deferred(), x = m.statusCode || {}, T = {}, w = {}, N = 0, C = {
                readyState: 0,
            ...
            if (v.promise(C), C.success = C.done, C.error = C.fail, C.complete = b.done, C.statusCode = function (e) {
                    if (e) {
                        var t;
                        if (2 > N)for (t in e)x[t] = [x[t], e[t]]; else t = e[C.status], C.then(t, t)
                    }
                    return this
            ...
            if (d = m.global, m.type = m.type.toUpperCase(), m.hasContent = !Ut.test(m.type), d && 0 === B.active++ && B.event.trigger("ajaxStart"), !m.hasContent && (m.data && (m.url += (Yt.test(m.url) ? "&" : "?") + m.data, delete m.data), i = m.url, m.cache === !1)) {
                var E = B.now(), S = m.url.replace(Zt, "$1_=" + E);
                m.url = S + (S === m.url ? (Yt.test(m.url) ? "&" : "?") + "_=" + E : "")
            }
            (m.data && m.hasContent && m.contentType !== !1 || n.contentType) && C.setRequestHeader("Content-Type", m.contentType), m.ifModified && (i = i || m.url, B.lastModified[i] && C.setRequestHeader("If-Modified-Since", B.lastModified[i]), B.etag[i] && C.setRequestHeader("If-None-Match", B.etag[i])), C.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + on + "; q=0.01" : "") : m.accepts["*"]);
        ...
        param: function (e, n) {
            ...
            if (n === t && (n = B.ajaxSettings.traditional), B.isArray(e) || e.jquery && !B.isPlainObject(e))B.each(e, function () {
    ...
    B.ajaxSetup({
        ...
        if ("jsonp" === t.dataTypes[0] || t.jsonp !== !1 && (ln.test(t.url) || i && ln.test(t.data))) {
            var o, a = t.jsonpCallback = B.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s = e[a], l = t.url, u = t.data, c = "$1" + a + "$2";
            return t.jsonp !== !1 && (l = l.replace(ln, c), t.url === l && (i && (u = u.replace(ln, c)), t.data === u && (l += (/\?/.test(l) ? "&" : "?") + t.jsonp + "=" + a))), t.url = l, t.data = u, e[a] = function (e) {
                o = [e]
            }, r.always(function () {
            ...
            return {
                send: function (i, o) {
                    ...
                    l.send(n.hasContent && n.data || null), r = function (e, i) {
                        var s, u, c, f, d;
                        try {
                            if (r && (i || 4 === l.readyState))if (r = t, a && (l.onreadystatechange = B.noop, cn && delete un[a]), i)4 !== l.readyState && l.abort(); else {
    ...
    var dn, pn, hn, mn, gn = {}, yn = /^(?:toggle|show|hide)$/, vn = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i, bn = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"], ["opacity"]];
    B.fn.extend({
        show: function (e, t, n) {
            var o, a;
            if (e || 0 === e)return this.animate(i("show", 3), e, t, n);
            for (var s = 0, l = this.length; l > s; s++)o = this[s], o.style && (a = o.style.display, !B._data(o, "olddisplay") && "none" === a && (a = o.style.display = ""), "" === a && "none" === B.css(o, "display") && B._data(o, "olddisplay", r(o.nodeName)));
            ...
            for (var r = 0, o = this.length; o > r; r++)if (this[r].style) {
            ...
            return B.isEmptyObject(e) ? this.each(o.complete, [!1]) : (e = B.extend({}, e), this[o.queue === !1 ? "each" : "queue"](function () {
                ...
                var t, n, i, a, s, l, u, c, f, d = B.extend({}, o), p = 1 === this.nodeType, h = p && B(this).is(":hidden");
                ...
                for (i in e)s = new B.fx(this, d, i), n = e[i], yn.test(n) ? s["toggle" === n ? h ? "show" : "hide" : n]() : (l = vn.exec(n), u = s.cur(), l ? (c = parseFloat(l[2]), f = l[3] || (B.cssNumber[i] ? "" : "px"), "px" !== f && (B.style(this, i, (c || 1) + f), u = (c || 1) / s.cur() * u, B.style(this, i, u + f)), l[1] && (c = ("-=" === l[1] ? -1 : 1) * c + u), s.custom(u, c, f)) : s.custom(u, n, ""));
                return !0
            }))
        }, stop: function (e, t) {
            return e && this.queue([]), this.each(function () {
                var e = B.timers, n = e.length;
        ...
        speed: function (e, t, n) {
            ...
            return r.duration = B.fx.off ? 0 : "number" == typeof r.duration ? r.duration : r.duration in B.fx.speeds ? B.fx.speeds[r.duration] : B.fx.speeds._default, r.old = r.complete, r.complete = function (e) {
        ...
        update: function () {
            ...
            var i = this, o = B.fx;
            this.startTime = mn || a(), this.start = e, this.end = t, this.unit = n || this.unit || (B.cssNumber[this.prop] ? "" : "px"), this.now = this.start, this.pos = this.state = 0, r.elem = this.elem, r() && B.timers.push(r) && !hn && (hn = setInterval(o.tick, o.interval))
        }, show: function () {
            ...
            var t, n, r = mn || a(), i = !0, o = this.elem, s = this.options;
            ...
            return 1 / 0 == s.duration ? this.now = r : (n = r - this.startTime, this.state = n / s.duration, this.pos = B.easing[s.animatedProperties[this.prop]](this.state, n, 0, 1, s.duration), this.now = this.start + (this.end - this.start) * this.pos), this.update(), !0
        }
    }, B.extend(B.fx, {
        tick: function () {
    ...
    var xn = /^t(?:able|d|h)$/i, Tn = /^(?:body|html)$/i;
    B.fn.offset = "getBoundingClientRect" in M.documentElement ? function (e) {
        ...
        var s = o.body, l = n(o), u = a.clientTop || s.clientTop || 0, c = a.clientLeft || s.clientLeft || 0, f = l.pageYOffset || B.support.boxModel && a.scrollTop || s.scrollTop, d = l.pageXOffset || B.support.boxModel && a.scrollLeft || s.scrollLeft, p = t.top + f - u, h = t.left + d - c;
        return {top: p, left: h}
    } : function (e) {
        var t = this[0];
        if (e)return this.each(function (t) {
        ...
        initialize: function () {
            ...
            B.extend(i.style, {
                ...
                height: "1px",
                visibility: "hidden"
            }), i.innerHTML = a, r.insertBefore(i, r.firstChild), e = i.firstChild, t = e.firstChild, n = e.nextSibling.firstChild.firstChild, this.doesNotAddBorder = 5 !== t.offsetTop, this.doesAddBorderForTableAndCells = 5 === n.offsetTop, t.style.position = "fixed", t.style.top = "20px", this.supportsFixedPosition = 20 === t.offsetTop || 15 === t.offsetTop, t.style.position = t.style.top = "", e.style.overflow = "hidden", e.style.position = "relative", this.subtractsBorderForOverflowNotVisible = -5 === t.offsetTop, this.doesNotIncludeMarginInBodyOffset = r.offsetTop !== o, r.removeChild(i), B.offset.initialize = B.noop
        }, bodyOffset: function (e) {
            var t = e.offsetTop, n = e.offsetLeft;
            return B.offset.initialize(), B.offset.doesNotIncludeMarginInBodyOffset && (t += parseFloat(B.css(e, "marginTop")) || 0, n += parseFloat(B.css(e, "marginLeft")) || 0), {
                top: t,
                left: n
            }
            ...
            var i, o, a = B(e), s = a.offset(), l = B.css(e, "top"), u = B.css(e, "left"), c = ("absolute" === r || "fixed" === r) && B.inArray("auto", [l, u]) > -1, f = {}, d = {};
            c ? (d = a.position(), i = d.top, o = d.left) : (i = parseFloat(l) || 0, o = parseFloat(u) || 0), B.isFunction(t) && (t = t.call(e, n, s)), null != t.top && (f.top = t.top - s.top + i), null != t.left && (f.left = t.left - s.left + o), "using" in t ? t.using.call(e, f) : a.css(f)
        }
    }, B.fn.extend({
        position: function () {
        ...
        B.fn["inner" + n] = function () {
            ...
            if (e === t) {
                var s = B.css(i, r), l = parseFloat(s);
...
!function (e) {
    e.host = function () {
        var e = window.location.protocol, t = "";
        return t = e.indexOf("https") > -1 ? e + "//nie.res.netease.com" : e + "//res.nie.netease.com"
    }()
}(jQuery), !function (e) {
    e.browser = e.browser || function () {
            var e = navigator.userAgent.toLowerCase(), t = /(webkit)[ \/]([\w.]+)/, a = /(opera)(?:.*version)?[ \/]([\w.]+)/, n = /(msie) ([\w.]+)/, i = /(mozilla)(?:.*? rv:([\w.]+))?/, r = t.exec(e) || a.exec(e) || n.exec(e) || e.indexOf("compatible") < 0 && i.exec(e) || [];
    ...
    jQuery.cookie = function (e, t, a) {
        if ("undefined" == typeof t) {
            var n = null;
            if (document.cookie && "" != document.cookie)for (var i = document.cookie.split(";"), r = 0; r < i.length; r++) {
        ...
        var l = a.path ? "; path=" + a.path : "", u = a.domain ? "; domain=" + a.domain : "", m = a.secure ? "; secure" : "";
    ...
    var t = function (e, t) {
        ...
        var a, n, i, r, c;
        return i = 2147483648 & e, r = 2147483648 & t, a = 1073741824 & e, n = 1073741824 & t, c = (1073741823 & e) + (1073741823 & t), a & n ? 2147483648 ^ c ^ i ^ r : a | n ? 1073741824 & c ? 3221225472 ^ c ^ i ^ r : 1073741824 ^ c ^ i ^ r : c ^ i ^ r
    }, n = function (e, t, a) {
        return e & t | ~e & a
    }, i = function (e, t, a) {
        return e & a | t & ~a
        ...
        for (var t, a = e.length, n = a + 8, i = (n - n % 64) / 64, r = 16 * (i + 1), c = Array(r - 1), o = 0, s = 0; a > s;)t = (s - s % 4) / 4, o = s % 4 * 8, c[t] = c[t] | e.charCodeAt(s) << o, s++;
    ...
    e.extend(e, {
        md5: function (e) {
            var t, n, i, r, c, p, f, d, b, y = Array(), w = 7, k = 12, x = 17, v = 22, _ = 5, C = 9, R = 14, z = 20, j = 4, S = 11, A = 16, G = 23, q = 6, P = 10, D = 15, L = 21;
            for (e = g(e), y = m(e), p = 1732584193, f = 4023233417, d = 2562383102, b = 271733878, t = 0; t < y.length; t += 16)n = p, i = f, r = d, c = b, p = o(p, f, d, b, y[t + 0], w, 3614090360), b = o(b, p, f, d, y[t + 1], k, 3905402710), d = o(d, b, p, f, y[t + 2], x, 606105819), f = o(f, d, b, p, y[t + 3], v, 3250441966), p = o(p, f, d, b, y[t + 4], w, 4118548399), b = o(b, p, f, d, y[t + 5], k, 1200080426), d = o(d, b, p, f, y[t + 6], x, 2821735955), f = o(f, d, b, p, y[t + 7], v, 4249261313), p = o(p, f, d, b, y[t + 8], w, 1770035416), b = o(b, p, f, d, y[t + 9], k, 2336552879), d = o(d, b, p, f, y[t + 10], x, 4294925233), f = o(f, d, b, p, y[t + 11], v, 2304563134), p = o(p, f, d, b, y[t + 12], w, 1804603682), b = o(b, p, f, d, y[t + 13], k, 4254626195), d = o(d, b, p, f, y[t + 14], x, 2792965006), f = o(f, d, b, p, y[t + 15], v, 1236535329), p = s(p, f, d, b, y[t + 1], _, 4129170786), b = s(b, p, f, d, y[t + 6], C, 3225465664), d = s(d, b, p, f, y[t + 11], R, 643717713), f = s(f, d, b, p, y[t + 0], z, 3921069994), p = s(p, f, d, b, y[t + 5], _, 3593408605), b = s(b, p, f, d, y[t + 10], C, 38016083), d = s(d, b, p, f, y[t + 15], R, 3634488961), f = s(f, d, b, p, y[t + 4], z, 3889429448), p = s(p, f, d, b, y[t + 9], _, 568446438), b = s(b, p, f, d, y[t + 14], C, 3275163606), d = s(d, b, p, f, y[t + 3], R, 4107603335), f = s(f, d, b, p, y[t + 8], z, 1163531501), p = s(p, f, d, b, y[t + 13], _, 2850285829), b = s(b, p, f, d, y[t + 2], C, 4243563512), d = s(d, b, p, f, y[t + 7], R, 1735328473), f = s(f, d, b, p, y[t + 12], z, 2368359562), p = l(p, f, d, b, y[t + 5], j, 4294588738), b = l(b, p, f, d, y[t + 8], S, 2272392833), d = l(d, b, p, f, y[t + 11], A, 1839030562), f = l(f, d, b, p, y[t + 14], G, 4259657740), p = l(p, f, d, b, y[t + 1], j, 2763975236), b = l(b, p, f, d, y[t + 4], S, 1272893353), d = l(d, b, p, f, y[t + 7], A, 4139469664), f = l(f, d, b, p, y[t + 10], G, 3200236656), p = l(p, f, d, b, y[t + 13], j, 681279174), b = l(b, p, f, d, y[t + 0], S, 3936430074), d = l(d, b, p, f, y[t + 3], A, 3572445317), f = l(f, d, b, p, y[t + 6], G, 76029189), p = l(p, f, d, b, y[t + 9], j, 3654602809), b = l(b, p, f, d, y[t + 12], S, 3873151461), d = l(d, b, p, f, y[t + 15], A, 530742520), f = l(f, d, b, p, y[t + 2], G, 3299628645), p = u(p, f, d, b, y[t + 0], q, 4096336452), b = u(b, p, f, d, y[t + 7], P, 1126891415), d = u(d, b, p, f, y[t + 14], D, 2878612391), f = u(f, d, b, p, y[t + 5], L, 4237533241), p = u(p, f, d, b, y[t + 12], q, 1700485571), b = u(b, p, f, d, y[t + 3], P, 2399980690), d = u(d, b, p, f, y[t + 10], D, 4293915773), f = u(f, d, b, p, y[t + 1], L, 2240044497), p = u(p, f, d, b, y[t + 8], q, 1873313359), b = u(b, p, f, d, y[t + 15], P, 4264355552), d = u(d, b, p, f, y[t + 6], D, 2734768916), f = u(f, d, b, p, y[t + 13], L, 1309151649), p = u(p, f, d, b, y[t + 4], q, 4149444226), b = u(b, p, f, d, y[t + 11], P, 3174756917), d = u(d, b, p, f, y[t + 2], D, 718787259), f = u(f, d, b, p, y[t + 9], L, 3951481745), p = a(p, n), f = a(f, i), d = a(d, r), b = a(b, c);
    ...
    e.chainclude = function (t, a) {
        ...
        var n = e.include.luid++, i = function (t, i) {
        ...
        t = e.makeArray(t), e.include.counter[n] = t.length, e.each(t, function () {
            e.include.load(this, i, null)
        })
    }, e.extend(e.include, {
        luid: 0, counter: [], load: function (t, a, n) {
            ...
            i.setAttribute("type", "text/css"), i.setAttribute("rel", "stylesheet"), i.setAttribute("href", t.toString()), e("head").get(0).appendChild(i), e.browser.msie ? e.include.IEonload(i, a, n) : a(n)
        }, loadJS: function (t, a, n) {
            var i = document.createElement("script"), r = /charset=([^&]+)/i.exec(t);
            i.setAttribute("defer", !0), i.setAttribute("charset", r && r[1] ? r[1] : "gbk"), i.src = t;
            var c = function () {
                "function" == typeof n && n(), e(i).remove()
            };
            e.browser.msie ? e.include.IEonload(i, a, c) : i.onload = function () {
                a(c)
    ...
    nie.site = nie.site || function () {
            var e = window.self.location.hostname, t = /^((?:[^\.]+\.)+)163\.com$/i.exec(e);
    ...
    nie.useJsURL = "", nie.use = function (t, a) {
        var n = t.sort().toString(), i = e.host + "/comm/js/" + (0 != window.self.location.href.indexOf("http") ? "use.php?p=" + n + "&" : "cache/" + e.md5(n)) + ".js";
    ...
    nie.define = function (e, t) {
        ...
        var a = t.toString().match(/nie\.require\([^\)]+\)/g), n = "", i = 0;
        if (e && (_defineList[e] = !0), !a || !a.length)return factoryProcess(t.__nieIndex);
        for (var r = 0; r < a.length; r++)a[r] = a[r].match(/\(([^\)]+)\)/i)[1].replace(/'|"/g, "");
        if (a = unique(a), a = filter(a, function (e) {
                return _defineList[e] ? !1 : !0
            }), !a || !a.length)return factoryProcess(t.__nieIndex);
        for (a = a.sort(function (e, t) {
            return e > t
        }), r = 0; r < a.length; r++)n += a[r].replace(/\./g, "/") + ".js,", _verHash[a[r]] && (i += _verHash[a[r]]);
        n = _host + "??" + n + "v=" + i + ".js", $.include(n, function () {
    ...
    nie.config = nie.config || {
            site: nie.site, stats: {
                ...
                id: null,
                url: {
                    _data: [], add: function (e, t) {
                        var a = "http://clickgame.163.com/" + nie.config.site + "/" + e, n = t || null;
                        nie.config.stats.url._data.push({
                            url: a,
                            title: n
                        }), nie.config.stats.loaded && nie.config.stats.url._run(a, n)
                    }, addto: function (e, t, a) {
                        var n = window.location.protocol + "//" + window.location.hostname + window.location.pathname + "?" + e, i = t || null;
                        a = a || window._ntes_nacc, nie.config.stats.url._data.push({
                            url: n,
                            title: i,
                            site: a
                        }), nie.config.stats.loaded && nie.config.stats.url._run(n, i, a)
                    }, _cb: function () {
    ...
    return "127.0.0.1" != t && "locahost" != t && "test.nie.163.com" != t && 0 != t.indexOf("10.") && 0 != t.indexOf("192.") ? $.ajax(e) : (url = e.url.replace(/#\S*/gi, ""), void $.ajax({
        type: "get",
    ...
    nie.util.stats = function () {
        ...
        if (null == nie.config.stats.id) {
            if (null != nie.config.site)if ("undefined" != typeof t[nie.config.site])a = n(nie.config.site); else {
                ...
                i = nie.config.site.match(/([^.]+)\.baike/), i && i.length > 1 && (a = n(i[1].split("-")[0])), i = nie.config.site.match(/tuku\.([^.]+)/), i && i.length > 1 && (a = n(i[1].split("-")[0])), null == a && nie.config.site.split(".").length < 2 && (a = n(nie.config.site))
            }
        } else a = n(nie.config.stats.id);
        null != a && e.include("//analytics.163.com/ntes.js", function () {
            nie.config.stats.loaded = !0, _ntes_nacc = a, e.isFunction(neteaseTracker) && neteaseTracker(), nie.config.stats.clickStats && (nie.config.stats.clickStatsPrecent ? neteaseClickStat(nie.config.stats.clickStatsPrecent) : neteaseClickStat()), nie.config.stats.url._cb()
        })
    }
}(jQuery);
var LocalData = {
    ...
    function e(e) {
        var t = "script" + Math.floor(1e5 * Math.random() + 1e5), a = 0, n = document.createElement("script");
        ...
        window[t] = function () {
            ...
            i(), a = 0
        }, 3e3), n.src = e.url + "?" + e.data + "&callback=" + t, document.body.appendChild(n)
    }

    return e
}();
if (window.ADData)ADBase.flag && (ADData.isInit = !0); else var ADData = window.ADData = {list: []}, ADBase = window.ADBase = {
    config: function (e) {
        ADData.list.push(e)
    }
};
var ADBase = function (e) {
    ...
    function a(e) {
        ...
        t = t.join(","), u({
            url: p.getData, data: "pos=" + t, success: function (e) {
                if (e.succ && "00" == e.result.code) {
                    var r = e.result.content;
                    n(r, t, a, i), setTimeout(function () {
                        s(t)
                    }, 1e3)
                } else c(t, a)
            }, error: function () {
    ...
    function r(e, t) {
        for (var a in t)!e[a] || e[a].length < 1 ? e[a] = t[a] : e[a] && e[a].length && t[a] && t[a].length ? e[a] = t[a] : e[a] && e[a].length && (!t[a] || t[a].length < 1) || (!t[a] || t[a].length < 1) && (!e[a] || e[a].length < 1) && (e[a] = []);
        return e
    }
    ...
    var l = e.jQuery || e.Zepto, u = (e.nie, e.__GetScript), m = e.JSON, h = e.LocalData, g = (e.ADData, "https://a.game.163.com"), p = {
        getData: g + "/fz/interface/frontend/fz.do",
        report: g + "/fz/interface/frontend/viewstatics.do"
    }, f = {config: t, flag: !0};
    return f
}(window, document);
!function (e) {
    nie.util.topBar = nie.util.topBar || function () {
            !nie.config.topBar.hasRun && document.getElementById("NIE-topBar") && (nie.config.topBar.hasRun = !0, e.include(e.host + "/comm/nie.topBar/js/topBar.v2.last.js")), (document.getElementById("NIE-topBar") || document.getElementById("NIE-topBar-include")) && nie.util.addStyle(".adbase-ctn{background:url(" + e.host + "/comm/js/nie/util/img/loading.png) center center no-repeat;}")
        }
}(jQuery), !function (e) {
    nie.util.copyRight = nie.util.copyRight || function () {
            var t = e("#NIE-copyRight"), a = e(".NIE-copyRight_m");
            if (t.length > 0 || a.length > 0) {
                var n = e.host + "/comm/NIE_copyRight/images/", i = "", r = "\u6587\u7f51\u6e38\u5907\u5b57", c = "\u6587\u7f51\u5907\u5b57", o = "", s = "\u7ca4\u7f51\u6587[2014]0636-236\u53f7", l = "\u6587\u7f51\u6587[2009]156\u53f7", u = "\u6d59\u7f51\u6587[2016]0155-055\u53f7", m = "", h = "", g = !0, p = 16, f = "\u672c\u6e38\u620f\u6545\u4e8b\u60c5\u8282\u8bbe\u7f6e\u7d27\u51d1", d = "", b = "\u672c\u6e38\u620f\u9002\u5408$age\u5c81\u4ee5\u4e0a\u7684\u73a9\u5bb6\u8fdb\u5165\u3002<br />", y = "\u79ef\u6781\u5065\u5eb7\u7684\u6e38\u620f\u5fc3\u6001\u662f\u5065\u5eb7\u6e38\u620f\u7684\u5f00\u7aef\uff0c\u672c\u6e38\u620f\u6545\u4e8b\u60c5\u8282\u8bbe\u7f6e\u7d27\u51d1\uff0c\u8bf7\u60a8\u5408\u7406\u63a7\u5236\u6e38\u620f\u65f6\u95f4\uff0c\u907f\u514d\u6c89\u6eba\u6e38\u620f\u5f71\u54cd\u751f\u6d3b\uff0c\u6ce8\u610f\u81ea\u6211\u4fdd\u62a4\uff0c\u9632\u8303\u7f51\u7edc\u9677\u9631\u3002<br />", w = ' <a href="http://game.163.com/bs/ca_lianyun.html" target="_blank">\u8054\u8fd0\u63a8\u5e7f</a> -', k = '<a href="http://www.cogcpa.org" target="_blank">\u4e2d\u56fd\u7f51\u7edc\u6e38\u620f\u7248\u6743\u4fdd\u62a4\u8054\u76df\u4e3e\u62a5\u4e2d\u5fc3</a>', x = !1, v = "", _ = !1, C = "", R = "", z = "\u7f51\u6613\u516c\u53f8\u7248\u6743\u6240\u6709", j = function (e, t, a, n, i) {
                    var r = P ? "_filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + a + "')" : "background:url(" + a + ") no-repeat", c = n, o = "_blank";
                    return n || (c = "javascript:void(0);", o = "_self"), "<a href=" + c + ' target="' + o + '" style="width:' + e + "px;height:" + t + "px;padding-right:" + (i ? "0" : "15px") + ";display:inline-block;cursor:pointer;" + r + '"></a>'
                }, S = 0, A = j(31, 31, n + "wen.png", "http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/toDetail/5F3BB7FDD27D4B01964F56E1FFBADD53"), G = j(31, 31, n + "wen.png", "http://sq.ccm.gov.cn/ccnt/sczr/service/business/emark/toDetail/700E4EB3C85B469E84A28595D0F16CFC"), q = j(31, 31, n + "wen.png", "http://sq.ccm.gov.cn:80/ccnt/sczr/service/business/emark/gameNetTag/4028c08c4b4e62fe014b523d7ba00a15") + j(31, 35, n + "wen2.png", "http://sq.ccm.gov.cn:80/ccnt/sczr/service/business/emark/gameNetTag/4028c08c4b4e62fe014b523d7ba00a15"), P = e.browser.msie && parseInt(e.browser.version) <= 6;
                switch (nie.config.copyRight.product) {
                    case"xyq":
                        o = r + "\u30102005\u3011017\u53f7\uff082011\uff09C-RPG042\u53f7", /^(www\.)?(\u68a6\u5e7b\u897f\u6e38|xn--owt49tjseb46a)\.(com|cn|net|\u4e2d\u56fd|xn--fiqs8s)$/i.test(window.self.location.hostname) && (d = "<a href='http://www.miibeian.gov.cn' target='_blank'>\u7ca4ICP\u5907B2-20090191</a>"), s = "\u7ca4\u7f51\u6587[2014]0636-236\u53f7", m = A;
                        break;
                    case"xyq.baike":
                        m = A, g = !1;
                        break;
                    case"xy2":
                        s = "\u7ca4\u7f51\u6587[2014]0636-236\u53f7", o = r + "(2011)C-RPG088\u53f7", /^(www\.)?(\u5927\u8bdd\u897f\u6e38|xn--pss230cs2tifc)\.(com|cn|net|\u4e2d\u56fd|xn--fiqs8s)$/i.test(window.self.location.hostname) && (d = "<a href='http://www.miibeian.gov.cn' target='_blank'>\u7ca4ICP\u5907B2-20090191</a>"), m = A;
                        break;
                    case"dh2":
                    ...
                    case"dtws":
                        ...
                        break;
                    case"jl":
                        f = "\u672c\u6e38\u620f\u73a9\u6cd5\u591a\u6837\uff0c\u5185\u5bb9\u4e30\u5bcc", b = "\u672c\u6e38\u620f\u9002\u5408\u6240\u6709\u5e74\u9f84\u73a9\u5bb6\u8fdb\u5165<br />", s = "\u7ca4\u7f51\u6587[2014]0636-236\u53f7", h = "\u65b0\u5e7f\u51fa\u5ba1[2016]788\u53f7", x = !0, m = A;
                        break;
                    case"ball":
                    ...
                    case"gift":
                        ...
                        break;
                    case"zg":
                        S = 1, o = r + "[2010]W-SLG012\u53f7", m = j(39, 35, n + "leihuo.png") + j(27, 31, n + "ccnt.png", "http://182.131.21.137/ccnt-apply/publicservice/applyonline/product/gameBase!gameNetTag.action?oprBean.id=F35FC9BEF88A52AEE040007F01003007");
                        break;
                    case"sg":
                        o = r + "[2010]W-SLG013\u53f7", f = "\u672c\u6e38\u620f\u4e3a\u5168\u5730\u56fePK\u533a\u57df\u6e38\u620f";
                        break;
                    case"ff":
                        o = r + "[2010]C-RPG001\u53f7", s = "\u7ca4\u7f51\u6587[2014]0636-236\u53f7", m = A, p = 14, /^(www\.)?(\u98de\u98de|xn--q35aa)\.(com|cn|net|\u4e2d\u56fd|xn--fiqs8s)$/i.test(window.self.location.hostname) && (d = "<a href='http://www.miibeian.gov.cn' target='_blank'>\u7ca4ICP\u5907B2-20090191</a>");
                        break;
                    case"popogame":
                        o = c + "[2008]011\u53f7", m = A;
                        break;
                    ...
                    case"qn":
                        ...
                        break;
                    case"qn2":
                        S = 1, m = j(39, 35, n + "leihuo.png") + G, s = u, o = r + "(2013)C-RPG001\u53f7", z = "\u676d\u5dde\u7f51\u6613\u96f7\u706b\u79d1\u6280\u6709\u9650\u516c\u53f8\u7248\u6743\u6240\u6709", k = "";
                        break;
                    case"fire":
                        m = j(39, 35, n + "leihuo.png"), g = !1, s = u;
                        break;
                    case"bw":
                        m = j(39, 35, n + "leihuo.png") + G + j(31, 35, n + "wen2.png", "http://sq.ccm.gov.cn:80/ccnt/sczr/service/business/emark/gameNetTag/4028c08c514355d5015156fbbfb51851"), s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]C-RPG1023\u53f7", z = "\u676d\u5dde\u7f51\u6613\u96f7\u706b\u79d1\u6280\u6709\u9650\u516c\u53f8\u7248\u6743\u6240\u6709", k = "", h = "\u65b0\u5e7f\u51fa\u5ba1[2016]290\u53f7";
                        break;
                    case"xcbw":
                        m = j(39, 35, n + "leihuo.png"), g = !1, s = u;
                        break;
                    ...
                    case"y3":
                        ...
                        break;
                    case"zh":
                        o = r + "[2015]C-RPG 0026 \u53f7", s = s, h = "\u65b0\u5e7f\u51fa\u5ba1[2016]507\u53f7", _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', m = A;
                        break;
                    case"tianyu":
                        m = q + j(88, 31, n + "pangu.{s}.png", !1), g = !1, s = u, o = r + "[2015]C-RPG0026\u53f7", z = "\u676d\u5dde\u7f51\u6613\u96f7\u706b\u79d1\u6280\u6709\u9650\u516c\u53f8\u7248\u6743\u6240\u6709", k = "", h = "\u65b0\u5e7f\u51fa\u5ba1[2016]375\u53f7";
                        break;
                    case"dao":
                    ...
                    case"lj":
                        ...
                        break;
                    case"bl":
                        S = 1, m = A + j(27, 31, n + "baolie.png", "http://182.131.21.137/ccnt-apply/publicservice/applyonline/product/gameBase!gameNetTag.action?oprBean.id=9AF4AACBFF6B4C2EB731F2CDE6ABBF43"), o = r + "(2014)C-RPG102\u53f7", s = "\u7ca4\u7f51\u6587[2014]0636-236\u53f7";
                        break;
                    case"nc":
                        g = !1, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-SLG0907\u53f7", _ = !0, s = u, C = "http://nc.163.com/client/userAgreement.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"fsqq":
                    ...
                    case"ngp":
                        ...
                        break;
                    case"gfxm1":
                        s = u, m = G + j(31, 35, n + "wen2.png", "http://sq.ccm.gov.cn:80/ccnt/sczr/service/business/emark/gameNetTag/4028c08c54807eb00154939e92a615ac"), z = "\u676d\u5dde\u7f51\u6613\u96f7\u706b\u79d1\u6280\u6709\u9650\u516c\u53f8\u7248\u6743\u6240\u6709", o = "\u6587\u7f51\u6e38\u5907\u5b57\u30142016\u3015\uff2d-RPG 1055 \u53f7", g = !1;
                        break;
                    case"gfxm":
                        s = u, z = "\u676d\u5dde\u7f51\u6613\u96f7\u706b\u79d1\u6280\u6709\u9650\u516c\u53f8\u7248\u6743\u6240\u6709", o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-CSG0980\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"ma":
                        s = u, o = "\u6587\u7f51\u6e38\u8fdb\u5b57[2015]0066\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"xqn":
                    case"qnm":
                        S = 1, m = j(39, 35, n + "leihuo.png") + G + j(31, 35, n + "wen2.png", "http://sq.ccm.gov.cn:80/ccnt/sczr/service/business/emark/gameNetTag/4028c08b54a4776a0154c7a856383626"), s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57\u30142016\u3015\uff2d-RPG 1694 \u53f7", z = "\u676d\u5dde\u7f51\u6613\u96f7\u706b\u79d1\u6280\u6709\u9650\u516c\u53f8\u7248\u6743\u6240\u6709", k = "";
                        break;
                    case"stzb":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-SLG0920\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"jianglin":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-CSG0910\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"sm":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-RPG0903\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"zgmh":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-SLG0906\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"gzbnl":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-RPG0905\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"smj":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-RPG0883\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"rz":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-CSG0994\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"ldxy":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-RPG0909\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"bjx":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-RPG0984", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"nyj":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-RPG1094", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"zlj":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-SLG1040\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"xsd":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-RPG0884\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"xym":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-RPG0983\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"sl":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-RPG1014\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"dc":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-RPG0908\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"mtj":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-RPG0982\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"dhxy":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-RPG1154\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"lm":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2016]M-RPG0081\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"sq":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2015]M-RPG0981\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"kf":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2016]M-RPG0147\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"doombad":
                        s = u, o = "\u6587\u7f51\u6e38\u8fdb\u5b57[2016]0022\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"xjzdy":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2016]M-SLG0156\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"txx":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2016]M-RPG0146\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"zzz":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2016]M-CSG0137\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"st":
                        s = u, o = r + "[2010]C-CSG004\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"tmllk":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2016]M-CSG0163\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"lzxxdn":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2016]M-SLG0716\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"pkzj":
                        s = u, o = "\u6587\u7f51\u6e38\u5907\u5b57[2016]M-CSG0929\u53f7", g = !1, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>';
                        break;
                    case"mmx":
                        o = "\u6587\u7f51\u6e38\u5907\u5b57\u30142016\u3015\uff2d-SLG 0088 \u53f7", m = G + j(31, 35, n + "wen2.png", "http://sq.ccm.gov.cn:80/ccnt/sczr/service/business/emark/gameNetTag/4028c08c51af8c94015214ebc2b5400a"), s = u, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', g = !1;
                        break;
                    case"yhl":
                        s = u, m = G + j(31, 35, n + "wen2.png", "http://sq.ccm.gov.cn:80/ccnt/sczr/service/business/emark/gameNetTag/4028c08c51af8c940151c9217cfd30ad"), o = "\u6587\u7f51\u6e38\u5907\u5b57\u30142016\u3015\uff2d-SLG 1185 \u53f7", _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', g = !1;
                        break;
                    case"th":
                        o = "\u6587\u7f51\u6e38\u5907\u5b57\u30142016\u3015\uff2d-RPG 0699 \u53f7", s = u, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', g = !1;
                        break;
                    case"sjbgl":
                        o = "\u6587\u7f51\u6e38\u5907\u5b57\u30142016\u3015\uff2d-RPG 0864 \u53f7", s = u, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', g = !1;
                        break;
                    case"ha":
                        o = "\u6587\u7f51\u6e38\u5907\u5b57\u30142016\u3015\uff2d-RPG 0857 \u53f7", s = u, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', g = !1;
                        break;
                    case"my":
                        o = "\u6587\u7f51\u6e38\u5907\u5b57\u30142015\u3015\uff2d-RPG 1055 \u53f7", s = u, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', g = !1;
                        break;
                    case"xyf":
                        o = "\u6587\u7f51\u6e38\u5907\u5b57\u30142016\u3015\uff2d-CSG 0858 \u53f7", s = u, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', g = !1;
                        break;
                    case"cs":
                        o = "\u6587\u7f51\u6e38\u5907\u5b57\u30142016\u3015\uff2d-CSG 0281 \u53f7", s = u, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', g = !1;
                        break;
                    case"mgzz":
                        s = "", o = "\u6587\u7f51\u6e38\u5907\u5b57\u30142016\u3015\uff2d-CSG 0852 \u53f7", _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', g = !1;
                        break;
                    case"hzhy":
                        o = "\u6587\u7f51\u6e38\u5907\u5b57\u30142016\u3015\uff2d-RPG 0701 \u53f7", s = u, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', g = !1;
                        break;
                    case"jdsj":
                        o = "\u6587\u7f51\u6e38\u5907\u5b57\u30142016\u3015\uff2d-SLG 1015 \u53f7", m = G + j(31, 35, n + "wen2.png", "http://sq.ccm.gov.cn:80/ccnt/sczr/service/business/emark/gameNetTag/4028c08b548079b501549e9195bf3eda"), s = u, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', g = !1;
                        break;
                    case"wxhd":
                        o = "\u6587\u7f51\u6e38\u5907\u5b57 [2016] M-RPG4294\u53f7", s = u, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', g = !1;
                        break;
                    case"mhws":
                        o = "\u6587\u7f51\u6e38\u5907\u5b57\u30142016\u3015\uff2d-RPG 4445\u53f7", s = u, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', g = !1;
                        break;
                    case"fnf":
                        o = "\u6587\u7f51\u6e38\u5907\u5b57\u30142016\u3015\uff2d-CSG 0861\u53f7", s = u, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', g = !1;
                        break;
                    case"wscs":
                        o = "\u6587\u7f51\u6e38\u8fdb\u5b57(2016)0053\u53f7", s = u, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', g = !1;
                        break;
                    case"yys":
                        o = "\u6587\u7f51\u6e38\u5907\u5b57\u30102016\u3011M-RPG4708\u53f7", s = u, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', g = !1;
                        break;
                    case"tx":
                        o = "\u6587\u7f51\u6e38\u5907\u5b57[2016]M-RPG 4600\u53f7", s = u, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', g = !1;
                        break;
                    case"justdance":
                        o = "\u6587\u7f51\u6e38\u5907\u5b57[2016]M-CSG 6656\u53f7", s = u, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', g = !1;
                        break;
                    case"au":
                        o = "\u6587\u7f51\u6e38\u5907\u5b57[2016]\uff2d-CSG4742\u53f7", s = u, _ = !0, C = "http://game.163.com/sy/client/userAgreement2.html", R = ' - <a href="' + C + '" target="_blank">\u7528\u6237\u534f\u8bae</a>', g = !1;
                        break;
                    case"xxd":
                    case"ltzs":
                    case"ssqq":
                ...
                var D = g && /^\/($|index.html|boot.html)/.test(window.self.location.pathname), L = "";
                window.self.location.pathname.match(/\/xyz_\S+/i) && (D = !0, s = u, m = A), /^\/($|index.html|tyfab.html)/.test(window.self.location.pathname) && "tianyu" == nie.config.copyRight.product && (D = !0, p = 18, d = ""), /^\/($|index.html|fab)/.test(window.self.location.pathname) && "lzxxdn" == nie.config.copyRight.product && (D = !0), "game" == nie.config.copyRight.product && window.self.location.pathname.indexOf("/sy/client/") >= 0 && (m = "", s = ""), "gm" == nie.config.copyRight.product && /^\/user_help.html/.test(window.self.location.pathname) && (s = u, L = '\u5168\u56fd\u6587\u5316\u5e02\u573a\u7edf\u4e00\u4e3e\u62a5\u7535\u8bdd\uff1a12318\u3000\u6587\u5316\u90e8\u7f51\u7edc\u6e38\u620f\u4e3e\u62a5\u548c\u8054\u7cfb\u7535\u5b50\u90ae\u7bb1\uff1a<a href="mailto:wlwh@vip.sina.com">wlwh@vip.sina.com</a><br />', D = !0);
                var B = '<a href="http://www.leihuo.net/jiazhang.html" style="display:inline-block;padding:2px;color:white;background-color:rgb(97,0,0);position:absolute;right:70px;top:38px;" target="_blank">\u70b9\u51fb\u67e5\u770b\u5bb6\u957f\u76d1\u62a4\u5de5\u7a0b&nbsp;&gt;</a>', I = {
                    wxdj: 1,
                    zmq: 1,
                    lj: 1,
                    dtws: 1,
                ...
                if (D) {
                    var E = "";
                    "bz" == nie.config.copyRight.product && (E = "\xa9CAPCOM U.S.A.,INC.2016 ALL RIGHTS RESERVED<br>"), "db" == nie.config.copyRight.product && (E = "\xa9VIRTUALTOYS Inc\uff0c\u7531\u5e7f\u5dde\u7f51\u6613\u8ba1\u7b97\u673a\u7cfb\u7edf\u6709\u9650\u516c\u53f8\u8fd0\u8425<br>"), "mc" == nie.config.copyRight.product && (E = "Minecraft\u662fMicrosoft\u65d7\u4e0bMojang\u5f00\u53d1\u76843D\u6c99\u76d2\u6e38\u620f\uff0c\u7535\u8111\u7aef\u53ca\u624b\u673a\u7aef\u7248\u672c\u5728\u4e2d\u56fd\u5927\u9646\u7531\u7f51\u6613\u6e38\u620f\u8fd0\u8425<br>"), "xy2" == nie.config.copyRight.product && (E = "<a href='http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=44010602000260' target='_blank'><img src='" + n + "beian.png' />\u7ca4\u516c\u7f51\u5b89\u5907 44010602000260\u53f7</a><br>"), "ff" == nie.config.copyRight.product && (E = "<a href='http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=44010602000312' target='_blank'><img src='" + n + "beian.png' />\u7ca4\u516c\u7f51\u5b89\u5907 44010602000312\u53f7</a><br>"), v = '<br><span id="ncp-l3" style="display:inline-block;padding-top:10px;">' + E + b.replace("$age", p) + y + L + (o ? '<a target="_blank" href="http://game.163.com/news/2010/6/9/442_216957.html">\u300a\u7f51\u7edc\u6e38\u620f\u7ba1\u7406\u6682\u884c\u529e\u6cd5\u300b</a>\u3000' : "") + o + (s ? "\u300a\u7f51\u7edc\u6587\u5316\u7ecf\u8425\u8bb8\u53ef\u8bc1\u300b" + s : "") + (h ? " " + h : "") + " " + d + "</span>", o = s = ""
                } else k = "";
                if (t.length > 0) {
                    (I[nie.config.copyRight.product] || T == u) && (o = "", s = "", k = "");
                    var N = D ? "width:" + (y ? 832 : 765) + "px;text-align:left;" : "width:100%;text-align:center;";
                    ("bw" == nie.config.copyRight.product || "qnm" == nie.config.copyRight.product) && (N = D ? "width:" + (y ? 900 : 765) + "px;text-align:left;" : "width:100%;text-align:center;"), "xqn" == nie.config.copyRight.product && (N = D ? "width:" + (y ? 900 : 765) + "px;text-align:left;" : "width:100%;text-align:center;"), i += '<p id="NIE-copyRight-corp" style="' + N + 'margin:0 auto;padding:15px 0 0 0;font-size:12px;font-family:\'\u5b8b\u4f53\';line-height:20px;display:block;position:relative;"><span style="position:relative;vertical-align:top;top:4px;display:inline-block;position:relative;">' + j(118, 31, n + "netease.{s}.png", "http://www.163.com", !0) + j(134, 31, n + "nie.{s}.png", "http://game.163.com") + m + '</span><span style="text-align:left;display:inline-block;padding-left:6px;"><span id="ncp-l1"><a href="http://gb.corp.163.com/gb/about/overview.html" target="_blank">\u516c\u53f8\u7b80\u4ecb</a> - <a href="http://help.163.com/" target="_blank">\u5ba2\u6237\u670d\u52a1</a> - <a href="http://gb.corp.163.com/gb/legal.html" target="_blank">\u76f8\u5173\u6cd5\u5f8b</a> - <a href="http://game.163.com/about/about.html" target="_blank">\u7f51\u6613\u6e38\u620f</a> - <a href="http://game.163.com/about/contactus.html" target="_blank">\u8054\u7cfb\u6211\u4eec</a> - <a href="http://game.163.com/bs/business.html" target="_blank">\u5546\u52a1\u5408\u4f5c</a> -' + (x ? w : "") + ' <a href="http://game.163.com/job/" target="_blank">\u52a0\u5165\u6211\u4eec</a>' + (_ ? R : "") + '</span><br /><span id="ncp-l2">' + z + " &copy;1997-2016\u3000" + o + "\u3000" + s + "  " + k + "</span></span>", (I[nie.config.copyRight.product] || T == u) && (D ? "xqn" == nie.config.copyRight.product && (B = B.replace("right:70px;", "right:50px;")) : B = B.replace("position:absolute;right:70px;top:38px;", "position:relative;left:-173px;top:2px;"), i += B, i = i.replace("line-height:20px;", "line-height:24px;")), i += "tx3" == nie.config.copyRight.product ? v + "<br><span>tx3.163.com\u7531\u5e7f\u5dde\u7f51\u6613\u8ba1\u7b97\u673a\u7cfb\u7edf\u6709\u9650\u516c\u53f8\u6388\u6743\u676d\u5dde\u7f51\u6613\u96f7\u706b\u79d1\u6280\u6709\u9650\u516c\u53f8\u4f7f\u7528</span></p>" : v + "</p>", t.html(i.replace(/{s}/g, nie.config.copyRight.getStyle())), nie.util.addStyle("#NIE-copyRight a{text-decoration: none;}#NIE-copyRight a:hover{text-decoration: underline;}")
                }
                if (a.length > 0) {
            ...
            processUrl: function () {
                ...
                function a(a) {
                    ...
                    if (n > 0) {
                        ...
                        var r = a.substring(n + 1), c = ["login", "username", "product"];
                ...
                if (e.inArray(this.url.raw, this.unionFabUrlList) >= 0)this.url.isUnion = !0, this.url.req = this.url.raw; else {
                    var n = a(this.url.raw);
                    this.url.req = n.req, n.hasOwnProperty("login") && (this.url.isUnion = !0, this.url.urs = n.login), n.hasOwnProperty("username") && (this.url.isUnion = !0, this.url.urs = n.username), n.hasOwnProperty("product") && (this.url.isUnion = !0, this.url.product = n.product)
                }
            },
    ...
    function t() {
        ...
        var t = 1, a = window, n = document.documentElement || document.body, i = a.devicePixelRatio;
        return i && 1 > i && i > 0 ? (t = i, n.dpr = i) : isNaN(screen.deviceXDPI) || isNaN(screen.logicalXDPI) ? a.outerWidth > 0 && a.innerWidth > 0 && (n.outerWidth = a.outerWidth, n.innerWidth = a.innerWidth, t = a.outerWidth / a.innerWidth) : t = screen.deviceXDPI / screen.logicalXDPI, n.zoom = t, 1 !== e(t, 1)
    }

    function a() {
        var t = '<div class="netease-tips" id="_js_neteaes_tips" style="position: fixed;width: 100%;height: 0;left: 0;bottom: 0;overflow: hidden;z-index: 1000000!important;;height: 45px;">                        <div style="position: relative;zoom: 1;width: 950px;margin: 0 auto;height: 45px;background: #cf1132;text-align: center;zoom: 1;">                            <a href="javascript:;" style="position: absolute;right: 15px;top: 10px;font-size: 18px;color: #fff;">&times;</a>                            <p style="margin: 0;padding: 0;line-height: 45px;color: #fff;font-size: 18px;">\u60a8\u6240\u8bbf\u95ee\u7684\u7f51\u9875\u5185\u5bb9\u88ab\u7f29\u653e\u53ef\u80fd\u5f71\u54cd\u6b63\u5e38\u4f7f\u7528\uff0c\u53ef\u4ee5\u4f7f\u7528\u952e\u76d8\u5feb\u6377\u952e <span style="text-decoration: underline!important;">Ctrl</span> \u548c <span style="text-decoration: underline!important;">0</span> \u6062\u590d\u6b63\u5e38\u3002</p>                        </div>                    </div>';
        e(document.body).append(t), e("#_js_neteaes_tips a").click(function () {
            e.cookie("_zoom_tips", "1", {
                expires: 7,
                path: "/",
                domain: "163.com",
                secure: !1
            }), e("#_js_neteaes_tips").remove()
        }), e(document).keydown(function (t) {
            t.ctrlKey && 96 == t.keyCode && e("#_js_neteaes_tips")[0] && (e.cookie("_zoom_tips", "1", {
                expires: 7,
                path: "/",
                domain: "163.com",
                secure: !1
